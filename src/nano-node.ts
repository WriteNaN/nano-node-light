...
class NanoPeer {
  ...
  public nanoSocket: any;
  public telemetry: any;
  public last_telemetry_req?: any;
...
export default class NanoNode extends EventEmitter {
    ...
    public nodeKey: any;
    public NodeID: any;
    public peers: Map<any, any>;
    public representatives: Map<any, any>;
    public elections: any;
    public inactiveElections: any;
    public _telemetryInterval: any;
    public server?: any;
  ...
  onConnection = (socket) => {
    const nanoSocket = new NanoSocket({ socket, node: this } as any);
