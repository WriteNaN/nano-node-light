...
export default class NanoSocket extends EventEmitter {
  ...
  public node?: any;
  public cookie: any;
  public connectedNodeId: any;
  public socket?: any;
  public peerAddress: any;
  public readableAddress?: any;
  public stream?: any;
  public handshakeResponded?: any;
  ...
  handleHandshake = ({ body, extensions }) => {
    ...
    if (handshake.response && !this.connectedNodeId) {
      ...
      if (!validation) {
        log(
          `received invalid handshake signature from ${this.readableAddress}`
        );
        return;
      }
  ...
  handleVote = ({ body, extensions }) => {
    ...
    if (voteInfo && voteInfo.isValid !== true) return;
